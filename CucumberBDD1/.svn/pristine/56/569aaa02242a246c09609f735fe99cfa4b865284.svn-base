...
import static seleniumutils.methods.BaseTest.assertionObj;
/**
...
public class TestDataHandler {
    ...
    public String getData(String key){
        ...
        switch(dataFormat){
            case "YAML":
                ...
                YAMLRecord ymlrec= (YAMLRecord) YAMLReader.recurseYAML(key,traverseMap);
    ...
    public static String traverseAndGet(String key, Map<String, Object> searchMap){//key=input_data.username.super_user | value = eqe147
        ...
        try {
            searchMap = traverseToParentMap(key, (Map<String, Object>) searchMap);
    ...
    public static void fillElement(String element,String value) {
        ...
        PageObject pObj= PageObjectGenerator.pageObjects.get(element);
        inputObj.fillElement(pObj.getType(),pObj.getAccess_name(),value);
    }
 ...
 /*   public static void validateElement(String element,String value) {
        ...
        PageObject pObj= PageObjectGenerator.pageObjects.get(element);
        assertionObj.fillElement(pObj.getType(),pObj.getAccess_name(),value);
    }*/
    /**
     * Main.
     *
