...
public class DataCompareTransaction {
...
//        System.out.print("Target Data Count: "+arrTargetFinal.getClass());
...
//                        System.out.println("Target : " + key1 + " Value" + value);
                        if (key1.contains(mapMappingData.get("Input_File_Field"))) {
                            ...
                            System.out.println(mapSource.get("SubType")+"AAAAAAAAAAAAAAAAAAAAAAA");
                            System.out.println(mapTarget.get("SubType")+"BBBBBBBBBBBBBBBBBBBBBBBB");

                            if(mapSource.get("SubType").contains("SN_CDS"))
                            {
                                cdsflag=cdsflag+1;
                                System.out.println(mapSource.get("SubType")+"Maninde");
                                if (mapSource.get("Traded Spread").contains(mapTarget.get("Leg1 Rate"))) {
                                    ...
                                    mapResult.put("Mismatch Column Name =" + "FIXED_RATE Maninder", " |Expected: " + mapSource.get("Traded Spread") + " | Actual: " + mapTarget.get("Leg1 Rate") + " |");
